...
# - - - Task 1: getConferenceSessions(websafeConferenceKey)
...
# - - - Task 1: getConferenceSessionsByType(websafeConferenceKey, typeOfSession)
...
# - - - Task 1: getSessionsBySpeaker(speaker) - - - #
